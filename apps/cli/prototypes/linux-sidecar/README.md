...
The prototype deliberately exposes only three versioned machine commands:
`exercise`, `reopen`, and `shutdown`. They are spike controls, not a proposal
for the production Repo Session protocol.
