...
Repository. Opening it starts mandatory authenticated IPv4-loopback HTTP and
leaves watching inactive. The same session may start and stop watching without
