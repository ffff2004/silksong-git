...
| Desktop sidecar process protocol              | Runtime schemas and the [Desktop Sidecar Process Protocol Reference](reference/desktop-sidecar-protocol.md)                                                                                                                           | Machine commands, responses, events, or exit behavior changes.  |
