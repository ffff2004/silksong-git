...
- [ADR-0008 — Use one local process for watching and the local history API](0008-one-local-process-owns-watching-and-local-history-api.md)
...
- [ADR-0011 — Split the fork into core, history, CLI, and Web workspace packages](0011-workspace-package-architecture.md)
...
- [ADR-0018 — Serve a secure versioned local HTTP Adapter from the watch process](0018-secure-versioned-local-http-adapter.md)
