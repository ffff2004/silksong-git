...
This is a temporary retirement inventory for
[#11](https://github.com/ffff2004/silksong-git/issues/11), not a replacement
architecture or contract. It classifies every second-level section above so
the final contract step can retire this document without preserving another
bulk archive. Destination documents link to live contracts and ADRs rather
than copying their details.

| Old section                     | Classification      | Durable owner or retirement disposition                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------- | ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Document Roles                  | Safe to delete      | [`docs/README.md`](README.md) owns navigation and authority after the contract step.                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Current-System References       | Legacy evidence     | Preserved pre-Solid behavior is under [`docs/legacy/web-before-solid/`](legacy/web-before-solid/overview.md); current behavior belongs to the [Web architecture](architecture/web.md).                                                                                                                                                                                                                                                                                                                    |
| Goals                           | Migrated            | Current capability flows belong to the [system overview](architecture/overview.md); unfinished delivery belongs to the [tracker roadmap](roadmap.md).                                                                                                                                                                                                                                                                                                                                                     |
| Non-Goals For The First Version | Migrated            | Direct SQLite access remains prohibited by the [system guardrails](architecture/overview.md#cross-module-guardrails); explicit-target restore is owned by [ADR-0007](adr/0007-restore-requires-explicit-target-or-in-place-confirmation.md); and the first-version CLI scope, including no interactive TUI, is owned by [ADR-0010](adr/0010-first-version-cli-command-set.md). Multi-save and a generic filter DSL remain deferred ideas with no accepted delivery commitment or project-level rejection. |
| High-Level Architecture         | Migrated            | Package topology and dependency direction belong to the [system overview](architecture/overview.md).                                                                                                                                                                                                                                                                                                                                                                                                      |
| Data Ownership                  | ADR-owned           | [ADR-0001](adr/0001-save-history-artifacts.md) owns the Git/SQLite decision; the [system overview](architecture/overview.md) describes current ownership.                                                                                                                                                                                                                                                                                                                                                 |
| Repository Layout               | ADR-owned           | [ADR-0006](adr/0006-save-history-repository-layout.md) owns the accepted layout decision; exact paths remain internal History implementation.                                                                                                                                                                                                                                                                                                                                                             |
| Observation Flow                | Migrated            | Persistence outcomes belong to the [Save History Module](architecture/save-history-module.md); scheduling belongs to the [Watch Process](architecture/local-history-watch-process.md).                                                                                                                                                                                                                                                                                                                    |
| Capture Policy                  | Migrated            | Capture outcomes belong to the [Save History Module](architecture/save-history-module.md), while deferred scheduling belongs to the [Watch Process](architecture/local-history-watch-process.md).                                                                                                                                                                                                                                                                                                         |
| Semantic Model                  | Migrated            | Current snapshot and event behavior belongs to the [Semantic Core](architecture/semantic-core.md).                                                                                                                                                                                                                                                                                                                                                                                                        |
| Numeric Event Rules             | ADR-owned           | [ADR-0014](adr/0014-numeric-semantic-event-rules.md) owns the accepted rules; live behavior belongs to Core's package-root tests.                                                                                                                                                                                                                                                                                                                                                                         |
| Display Semantic Event Filters  | Migrated            | Query-time ownership belongs to the [Save History Module](architecture/save-history-module.md); exact config and result types remain live contracts.                                                                                                                                                                                                                                                                                                                                                      |
| Version Stamps                  | Migrated            | Current semantic stamps belong to the [Semantic Core](architecture/semantic-core.md); rationale remains in [ADR-0015](adr/0015-version-stamps-for-decoding-and-semantic-mapping.md).                                                                                                                                                                                                                                                                                                                      |
| Config Model                    | ADR-owned           | [ADR-0004](adr/0004-config-scopes-and-precedence.md) owns precedence; exact config shapes remain live History contracts.                                                                                                                                                                                                                                                                                                                                                                                  |
| Core Module Interface           | Live-contract-owned | Package-root [`@silksong-git/core` exports](../packages/core/src/index.ts) and behavior tests own exact callable types and behavior.                                                                                                                                                                                                                                                                                                                                                                      |
| History Module Interface        | Live-contract-owned | Package-root [`@silksong-git/history` exports](../packages/history/src/index.ts) and behavior tests own exact callable types and behavior.                                                                                                                                                                                                                                                                                                                                                                |
| Local History Watch Process     | Migrated            | Current lifecycle belongs to the [Watch Process architecture](architecture/local-history-watch-process.md); its documented implementation gaps are future tracker work in [#16](https://github.com/ffff2004/silksong-git/issues/16).                                                                                                                                                                                                                                                                      |
| Local HTTP Adapter              | Live-contract-owned | Runtime schemas and generated OpenAPI own exact wire behavior; the [Local HTTP reference](reference/local-http-api.md) owns human navigation. The remaining public-Interface boundary fix is [#15](https://github.com/ffff2004/silksong-git/issues/15).                                                                                                                                                                                                                                                   |
| CLI Command Set                 | Live-contract-owned | Current syntax and behavior belong to the [CLI reference](reference/cli.md), CLI implementation, and tests; `ui open` remains future tracker work in [#14](https://github.com/ffff2004/silksong-git/issues/14).                                                                                                                                                                                                                                                                                           |
| Repo Context Resolution         | Live-contract-owned | Current resolution behavior belongs to the [CLI reference](reference/cli.md) and CLI behavior tests.                                                                                                                                                                                                                                                                                                                                                                                                      |
| CLI Safety Classes              | Live-contract-owned | Current side effects and safeguards belong to the [CLI reference](reference/cli.md) and public command behavior.                                                                                                                                                                                                                                                                                                                                                                                          |
| CLI Error Behavior              | Live-contract-owned | Current exits and user-facing failures belong to the [CLI reference](reference/cli.md) and CLI behavior tests.                                                                                                                                                                                                                                                                                                                                                                                            |
| Restore Safety                  | ADR-owned           | [ADR-0007](adr/0007-restore-requires-explicit-target-or-in-place-confirmation.md) owns the decision; current workflows belong to the [Save History Module](architecture/save-history-module.md) and live contracts.                                                                                                                                                                                                                                                                                       |
| Web UI Modes                    | Migrated            | Current Solid behavior belongs to the [Web architecture](architecture/web.md); pre-Solid material is [legacy evidence](legacy/web-before-solid/overview.md), and unfinished delivery remains in [#13](https://github.com/ffff2004/silksong-git/issues/13) and [#14](https://github.com/ffff2004/silksong-git/issues/14).                                                                                                                                                                                  |
| Accepted ADRs                   | ADR-owned           | The [ADR index](adr/README.md) is the durable decision inventory.                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Open Design Questions           | Safe to delete      | The resolved and deferred dispositions are recorded below; the original question list is not an ongoing authority.                                                                                                                                                                                                                                                                                                                                                                                        |

Embedded phase/task sequencing notes such as the P5-T5/P5-T7 flag staging are
safe to delete as transient implementation history. Embedded later-version
ideas such as a CLI Raw Save Observation listing remain deferred rather than
rejected or scheduled; unresolved Core mapping ideas remain explicitly
deferred in the [Semantic Core architecture](architecture/semantic-core.md).
The only explicitly incomplete delivery slices carried from the old
implementation plan are represented by
[#13](https://github.com/ffff2004/silksong-git/issues/13) and
[#14](https://github.com/ffff2004/silksong-git/issues/14). The migration review
also identified the implementation gaps now owned by
[#15](https://github.com/ffff2004/silksong-git/issues/15) and
[#16](https://github.com/ffff2004/silksong-git/issues/16). Completed task logs
remain owned by commits and CI rather than a replacement archive.

The open questions have these dispositions:

| Old question                            | Disposition                                                                                                                                                                                                                             |
| --------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Exact Core and config TypeScript shapes | Resolved: package-root exports and their behavior tests are the live contract; architecture intentionally does not copy them.                                                                                                           |
| Exact SQLite schema and migrations      | Resolved ownership: the schema is a private, rebuildable History implementation detail, not a public documentation contract.                                                                                                            |
| Endpoint/token transfer UX              | Resolved current fact: the [Web architecture](architecture/web.md) documents the in-memory Topbar dialog and authenticated handshake; later CLI-assisted handoff is [#14](https://github.com/ffff2004/silksong-git/issues/14).          |
| Frontend serving strategy               | Future tracker work: production opening or serving is outside the Watch Process and is owned by [#14](https://github.com/ffff2004/silksong-git/issues/14).                                                                              |
| Streaming status or durable diagnostics | Deferred idea: polling is the current architecture. No streaming or durable-diagnostics outcome has been accepted, and this is not a project-level rejection.                                                                           |
| Exact CLI text formatting               | Resolved ownership: current human and machine output behavior belongs to the [CLI reference](reference/cli.md), implementation, and tests; human-readable output is not a byte-stable contract.                                         |
| Multi-save workspaces                   | Deferred idea: one repository per Watched Save remains the accepted current boundary in [ADR-0005](adr/0005-single-save-history-repository.md). No multi-save outcome has been accepted, and the idea is not a project-level rejection. |
