...
**Command Set**:
The first-version CLI surface for initializing a repository, watching a save, producing one-off snapshots, viewing history, diffing commits, searching events, restoring saves, rebuilding the Semantic Read Model, and launching the local Web UI.
